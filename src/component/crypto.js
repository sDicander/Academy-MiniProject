...
export const Crypto = () => {
  ...
  const search = (e) => {
    if (e.key === "Enter") {
      fetch(
       // "https://coinranking1.p.rapidapi.com/coins?timePeriod=24h&symbols%5B0%5D=BTC&tiers%5B0%5D=1&orderBy=marketCap&orderDirection=desc&limit=50&offset=0",
          `https://coinranking1.p.rapidapi.com/coins?timePeriod=24h&symbols%5B0%5D=${query}&tiers%5B0%5D=1&orderBy=marketCap&orderDirection=desc&limit=50&offset=0`,
options
      )
